...
obs_blprxp = BdToDstEllNuPrediction("mu", "mu", BdToDstFF.BLPRXP())
...
p = obs_blprxp.plot_obs_prediction(obs, label="BLPRXP", plot=p)
...
p[1].legend()
p[0].savefig(f"output/example_compare_FFschemes_{obs}.png", bbox_inches="tight")
p[0].show()