...
from slophep.Predictions.FormFactorsBToDstst.BToD1LLSW import LLSW_BToD1
...
from slophep.Predictions.FormFactorsBToDstst.BToD2stLLSW import LLSW_BToD2st
